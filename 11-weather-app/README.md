...
A simple and responsive weather application built using **HTML, CSS, Bootstrap, and JavaScript**.  
...
- **Error handling**:
  - Shows message if city not found
  - Prompts user to enter a city if input is empty
- **Responsive design**:
...
2. Open the folder `11-weather-app`.
